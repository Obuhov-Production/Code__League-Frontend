...
const ABOUT_COLUMNS = [
  ...
  },
  {
    ...
    detail: {
      ...
      features: [
        'Збирай свою команду або приєднуйся до інших',
        'Інформація про відкриті та закриті турніри',
  ...
  },
  {
    ...
    detail: {
      ...
      features: [
        'Вибирай турніри відповідно до свого рівня',
        'Отримуй досягнення на платформі',
        'В деяких турнірах можна вигравати реальні призи та стажування',
      ],
    },
  },
]
