...
export const TOURNAMENT_EMOJIS = [
  // 🏆 Турниры, победы и рейтинг
  '🏆', '🥇', '🥈', '🥉', '🏅', '🎖️', '👑', '⭐', '🌟', '🔥', '💯',
  // 💻 Программирование и разработка
  '💻', '⌨️', '🖱️', '🖥️', '📱', '🧑‍💻', '👨‍💻', '👩‍💻', '🤖', '🧠',
  '⚙️', '🛠️', '🔧', '🔩', '🧰', '📦', '🗂️',
  // 🧩 Алгоритмы, задачи и логика
  '🧩', '🎯', '🎲', '♟️', '🧠', '💡', '🔍', '📐', '📏', '🧮',
  '📊', '📈', '📉',
  // 🐛 Баги, дебаг и тестирование
  '🐛', '🐞', '🔎', '🧪', '✅', '❌', '⚠️', '🚫', '🧹', '🧯',
  // 🚀 Хакатоны, стартапы и инновации
  '🚀', '⚡', '💥', '✨', '🛸', '🛰️', '🌐', '🔌', '💾', '💿',
  // 🏢 Работодатели, вакансии и реальные задания
  '🏢', '💼', '📋', '📄', '📝', '📌', '📍', '🤝', '🪪', '💬',
  '📧', '📞',
  // 🔐 Backend, DevOps, безопасность
  '🔐', '🔒', '🛡️', '🗄️', '🗃️', '🧱', '🌍', '☁️', '📡', '🛰️',
  '🔗', '🧬',
  // 🎨 Frontend, UI/UX и дизайн
  '🎨', '🖌️', '🖍️', '✏️', '🖼️', '📐', '🧵', '🎭', '🪄',
  // 🎮 Геймификация платформы
  '🎮', '🕹️', '👾', '🎰', '🎪', '🎊', '🎉', '🎈', '🎁', '🎀',
  // ⚔️ Соревнования и челленджи
  '⚔️', '🛡️', '🗡️', '🏹', '🥊', '💪', '⏱️', '⏳', '🚦', '🏁',
  // 📚 Обучение и развитие
  '📚', '📖', '🎓', '🧑‍🏫', '🔬', '⚗️', '🧪', '📝', '💡',
  // 💬 Команды и коммуникация
  '👥', '🧑‍🤝‍🧑', '🤝', '💬', '🗨️', '📣', '📢', '📨',
  // 🌍 Онлайн-платформа и сообщество
  '🌐', '🌍', '🌎', '🌏', '🧭', '📡', '🔗', '🪐',

  // 🎭 Специальные статусы и события
  '❓', '❗', '❕', '❔', '⭕', '✅', '❌', '⚠️', '🚀', '🔥',
];
